...
for (day in firstDay:lastDay)
{
  ...
  # collect output data
  simulatedDate <- c(simulatedDate, rep(weatherData$date[day], nrow(soilLayerData)))
  simulatedDepth <- c(simulatedDepth, c(soilLayerData$LayerTop+soilLayerData$LayerBot)/2)
  simulatedTemperature <- c(simulatedTemperature, round(onProcessState$layer_temp, 6))
}
