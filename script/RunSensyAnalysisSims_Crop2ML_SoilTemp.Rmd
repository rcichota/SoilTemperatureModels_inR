...
temperatureModel <- modelsToRun[6]
testToRun <- "One"
...
run_SensitivityScenario <- function(temperatureModel, locationID, soilID, laiID, pawID )
{
  ...
  biomassCoverToRun <- list("LAI"=laiID, "biomassCover"=switch(which(laisToRun==laiID), biomassesToRun))
...
biomassCoverData <- biomassCoverToRun
