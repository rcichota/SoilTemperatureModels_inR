...
model_stemp_ <- function (TMAX,
    ...
    #'                          ** min : 
    #'                          ** unit : degC
    list[CUMDPT, DSMID, TDL, TMA, ATOT, SRFTEMP, ST] <- model_stemp(NL, ISWWAT, BD, DLAYR, DS, DUL, LL, NLAYR, MSALB, SRAD, SW, TAVG, TMAX, XLAT, TAV, TAMP, CUMDPT, DSMID, TDL, TMA, ATOT, SRFTEMP, ST, DOY, HDAY)
