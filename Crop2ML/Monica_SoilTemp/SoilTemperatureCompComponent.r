...
#         V,
    ...
    soilTemperature <- model_soiltemperature(noOfSoilLayers, noOfTempLayers, soilSurfaceTemperature, layerThickness, initialSoilTemperature, B, volumeMatrix, volumeMatrixOld, matrixPrimaryDiagonal, matrixSecondaryDiagonal, heatConductivityMean, solution, matrixDiagonal, matrixLowerTriangle, heatFlow)
